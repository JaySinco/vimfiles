...
vim.keymap.set('n', 'sl', ':SessionManager load_session<cr>', opts)
vim.keymap.set('n', 'sa', ':SessionManager load_last_session<cr>', opts)
vim.keymap.set('n', 'ss', ':SessionManager save_current_session<cr>', opts)
vim.keymap.set('n', 'sd', ':SessionManager delete_session<cr>', opts)